...
mesaIndividualRouter.post("/criar_mesa", new CriartMesasIndividuaisController().handle)
mesaIndividualRouter.post("/reserva_mesa", new CreateReservaMesaIndividualController().handle)
mesaIndividualRouter.put("/reserva_mesa_individual/status/:id", new UpdataStatusReservaMesaIndividualController().handle)
